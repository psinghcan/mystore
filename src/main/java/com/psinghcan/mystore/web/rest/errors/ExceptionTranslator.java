package com.psinghcan.mystore.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.psinghcan.mystore.service.EmailAlreadyUsedException ||
            ex instanceof com.psinghcan.mystore.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.psinghcan.mystore.service.InvalidPasswordException
